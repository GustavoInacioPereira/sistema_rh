           ...
           switch (optionRegime) {
            ...
            switch (optionAdmissao) {
                case 1:
                    ...
                    if (Cargos.values()[codCargo].isLideranca()) {
                            ...
                            funcionarios.add(new FuncionarioLideranca (name, Cargos.values()[codCargo], isAdmittedToday, escolhaRegimeContrato,loginDigitado, senhaDigitada));
                    } else {
                ...
                case 2:
                    ...
                    if (Cargos.values()[codCargo].isLideranca()) {
                            ...
                            System.out.printf("Digite a Senha: %n");
                            String senhaDigitada = sc.nextLine();
                            funcionarios.add(new FuncionarioLideranca (name, Cargos.values()[codCargo], date, escolhaRegimeContrato,loginDigitado, senhaDigitada));
                    } else {
